function Footer() {
  return (
    <div data-scroll data-scroll-section className="w-full flex gap-5 p-20 h-screen bg-slate-900">
      <div className="w-1/2 h-full flex flex-col justify-between font-bebas-neue">
        <div className="heading">
          <h1 className="text-[8vw] font-semibold leading-none -mb-8">eye-</h1>
          <h1 className="text-[8vw] font-semibold leading-none -mb-8">
            opening
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2">
        <h1 className="text-[8vw] font-semibold leading-none font-bebas-neue -mb-8">
          Presentations
        </h1>
        <div className="flex mt-16 font-darker-grotesque text-[1.3vw] font-medium justify-between">
          <div className="flex flex-col space-y-6">
            ...
            <div className="flex flex-col space-y-7">
              <p className="">E:</p>
              <a href="mailto:hello@ochi.design" className="hover:underline">
                hello@ochi.design
              </a>
            </div>
          </div>
        ...
        <footer className="flex mt-28 text-gray-500 justify-between text-sm">
